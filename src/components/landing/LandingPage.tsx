                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <div className="group flex items-center gap-4 rounded-xl border border-gray-100 bg-white p-4 shadow-sm transition-all hover:border-blue-200 hover:shadow-md">
                      <span className="flex h-12 w-12 items-center justify-center rounded-full bg-blue-50 text-[#135bec] transition-colors group-hover:bg-[#135bec] group-hover:text-white">
                        ...
                        >
                          <path
                            d="M22 16.92v3a2 2 0 0 1-2.18 2 19.86 19.86 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.86 19.86 0 0 1-3.07-8.63A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72c.12 1.05.36 2.06.7 3.01a2 2 0 0 1-.45 2.11L8.09 10.91a16 16 0 0 0 6 6l1.07-1.07a2 2 0 0 1 2.11-.45c.95.34 1.96.58 3.01.7A2 2 0 0 1 22 16.92z"
                            stroke="currentColor"
                            strokeWidth="1.5"
                            strokeLinecap="round"
                            strokeLinejoin="round"
