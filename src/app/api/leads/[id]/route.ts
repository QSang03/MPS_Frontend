...
export async function GET(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    const response = await backendApiClient.get(API_ENDPOINTS.LEADS.DETAIL(params.id), {
      params: queryParams,
...
export async function PATCH(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    const response = await backendApiClient.patch(API_ENDPOINTS.LEADS.UPDATE(params.id), payload, {
      headers: { Authorization: `Bearer ${accessToken}` },
    })
...
export async function DELETE(request: NextRequest, { params }: { params: { id: string } }) {
  try {
    ...
    const response = await backendApiClient.delete(API_ENDPOINTS.LEADS.DELETE(params.id), {
      headers: { Authorization: `Bearer ${accessToken}` },
    })
