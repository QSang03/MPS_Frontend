...
export async function PATCH(
  ...
  let consumableTypeId: string | undefined = undefined
  try {
    const paramsObj = await params
    deviceId = paramsObj.id
    // Param name is [consumableId] in file structure; interpret as consumableTypeId
    consumableTypeId = paramsObj.consumableId
    ...
    const response = await backendApiClient.patch(
      `/devices/${deviceId}/consumables/${consumableTypeId}/warning`,
      cleaned,
    ...
    console.error(
      'API Route /api/devices/[id]/consumables/[consumableId]/warning PATCH error:',
