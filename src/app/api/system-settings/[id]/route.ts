...
export async function GET(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const response = await backendApiClient.get(`${SYSTEM_SETTINGS_ENDPOINT}/${id}`, {
      headers: {
    ...
    const err = error as
      ...
      | undefined
    console.error('API Route /api/system-settings/[id] error:', error)
...
export async function PATCH(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const response = await backendApiClient.patch(`${SYSTEM_SETTINGS_ENDPOINT}/${id}`, reqBody, {
    ...
    const err = error as
      ...
      | undefined
    console.error(
      'API Route /api/system-settings/[id] PATCH error:',
