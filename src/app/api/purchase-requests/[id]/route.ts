...
export async function GET(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const response = await backendApiClient.get(API_ENDPOINTS.PURCHASE_REQUESTS.DETAIL(id), {
...
export async function DELETE(
  ...
  try {
    ...
    await backendApiClient.delete(API_ENDPOINTS.PURCHASE_REQUESTS.DELETE(id), {
      headers: { Authorization: `Bearer ${accessToken}` },
    })
