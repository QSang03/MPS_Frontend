...
export async function GET(request: NextRequest) {
  try {
    ...
    const response = await backendApiClient.get(API_ENDPOINTS.PURCHASE_REQUESTS.LIST, {
      params,
      headers: {
...
export async function POST(request: NextRequest) {
  try {
    ...
    const response = await backendApiClient.post(API_ENDPOINTS.PURCHASE_REQUESTS.CREATE, cleaned, {
