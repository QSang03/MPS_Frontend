...
export async function GET(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const response = await backendApiClient.get(`${API_ENDPOINTS.CUSTOMERS}/${id}`, {
      headers: {
...
export async function PATCH(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  try {
    ...
    const response = await backendApiClient.patch(`${API_ENDPOINTS.CUSTOMERS}/${id}`, cleaned, {
      headers: {
        Authorization: `Bearer ${accessToken}`,
      },
    })
...
export async function DELETE(
  ...
  try {
    ...
    await backendApiClient.delete(`${API_ENDPOINTS.CUSTOMERS}/${id}`, {
      headers: {
        Authorization: `Bearer ${accessToken}`,
      },
    })
