          ...
          <Table>
            <TableHeader className={CONSUMABLE_STYLES.typography.tableHeader}>
              <TableRow>
                ...
                <TableHead className={CONSUMABLE_STYLES.spacing.cellPadding}>Part Number</TableHead>
                <TableHead className={CONSUMABLE_STYLES.spacing.cellPadding}>Serial</TableHead>
                <TableHead className={CONSUMABLE_STYLES.spacing.cellPadding}>Tên vật tư</TableHead>
                <TableHead className={CONSUMABLE_STYLES.spacing.cellPadding}>
                  Dòng tương thích
                </TableHead>
                <TableHead className={CONSUMABLE_STYLES.spacing.cellPadding}>Dung lượng</TableHead>
                <TableHead className={CONSUMABLE_STYLES.spacing.cellPadding}>
                  Trạng thái lắp đặt
                </TableHead>
                <TableHead className={CONSUMABLE_STYLES.spacing.cellPadding}>Trạng thái</TableHead>
              ...
              {loading ? (
                ...
                filteredConsumables.map((c: Record<string, unknown>, idx: number) => (
                  ...
                  >
                    ...
                    <TableCell className={cn(CONSUMABLE_STYLES.spacing.cellPadding, 'text-right')}>
                      <DropdownMenu>
