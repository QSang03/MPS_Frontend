...
export default function UserServiceRequestDetail() {
  ...
  if (!request) return <div className="p-8 text-center">Not found</div>
        ...
        <div className="space-y-2">
          ...
          <div className="text-muted-foreground flex flex-wrap items-center gap-3 text-sm">
            ...
            <span className="flex items-center gap-1">
              {request.createdByName ?? request.createdBy ?? 'Khách'}
            </span>
          </div>
        </div>
        <Dialog
        ...
        <div className="space-y-6 lg:col-span-8">
          <Card className="overflow-hidden border-none shadow-sm ring-1 ring-slate-200 dark:ring-slate-800">
            <CardHeader className="bg-slate-50/50 pb-3 dark:bg-slate-900/50">
              <CardTitle className="text-base font-medium">Mô tả chi tiết</CardTitle>
            </CardHeader>
          ...
          <Card className="flex h-[600px] flex-col border-none shadow-sm ring-1 ring-slate-200 dark:ring-slate-800">
            <CardHeader className="pb-3">
              <CardTitle className="text-base font-medium">Trao đổi & Thảo luận</CardTitle>
        ...
        <div className="space-y-6 lg:col-span-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value={ServiceRequestStatus.CLOSED}>Đóng yêu cầu</SelectItem>
                      </SelectContent>
                    </Select>
                    <Textarea
          ...
          <Card>
            ...
            <CardContent className="space-y-3 pt-4">
              ...
              <div className="grid gap-2 text-sm">
                <InfoRow label="Email" value={request.customer?.contactEmail} />
                <InfoRow label="Phone" value={request.customer?.contactPhone} />
                <InfoRow label="Liên hệ" value={request.customer?.contactPerson} />
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-3 pt-4">
              {request.device ? (
                <div className="grid gap-2 text-sm">
                  <InfoRow label="Model" value={request.device.deviceModel?.name} />
                  <InfoRow label="Serial" value={request.device.serialNumber} />
                  <InfoRow label="IP" value={request.device.ipAddress} />
                  <InfoRow label="Vị trí" value={request.device.location} />
                  <div className="pt-1">
